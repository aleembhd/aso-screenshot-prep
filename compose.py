#!/usr/bin/env python3
"""
Play Store Scaffold Composer
Composites headline text, an Android device frame, and an app screenshot
into a clean "scaffold" image — the draft layout you then hand to an
image model (e.g. ChatGPT) along with a per-image prompt to produce the
final, polished Google Play Store marketing screenshot.
